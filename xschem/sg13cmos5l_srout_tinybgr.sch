...
N 80 -150 80 -130 {lab=Vbe2}
N 280 -330 300 -330 {lab=#net2}
N 150 -330 220 -330 {lab=Vgn}
N 150 -480 200 -480 {lab=Vgp}
N 260 -480 270 -480 {lab=#net1}
N -80 -450 -80 -270 {lab=VREF}
N -240 -540 -90 -540 {lab=AVDD}
N -240 -420 -220 -420 {lab=AVSS}
N -240 -390 -240 -380 {lab=Vgn}
N -240 -380 80 -380 {lab=Vgn}
N 80 -390 80 -380 {lab=Vgn}
...
N -360 -480 -340 -480 {lab=VREF}
N -340 -30 80 -30 {lab=AVSS}
N -340 -270 -80 -270 {lab=VREF}
N -340 -340 -340 -270 {lab=VREF}
N -400 -450 -400 -440 {lab=#net3}
N -360 -410 -340 -410 {lab=VREF}
N -340 -480 -340 -410 {lab=VREF}
N -410 -410 -400 -410 {lab=AVDD}
N -410 -480 -410 -410 {lab=AVDD}
N -310 -420 -280 -420 {lab=vgsu1}
N -410 -340 -410 -270 {lab=AVDD}
N -410 -270 -400 -270 {lab=AVDD}
N -410 -340 -400 -340 {lab=AVDD}
N 40 -330 80 -330 {lab=AVSS}
N 280 -160 280 -100 {lab=AVSS}
N 340 -160 340 -130 {lab=Vbe1}
N 340 -300 340 -260 {lab=Vbe2mr}
N 220 -160 220 -150 {lab=Vbe2}
N 80 -150 220 -150 {lab=Vbe2}
N 80 -300 80 -150 {lab=Vbe2}
N 220 -270 220 -260 {lab=VREF}
N -80 -270 220 -270 {lab=VREF}
N -400 -380 -400 -370 {lab=#net4}
N -410 -410 -410 -340 {lab=AVDD}
N -360 -270 -340 -270 {lab=VREF}
N -360 -340 -340 -340 {lab=VREF}
N -340 -410 -340 -340 {lab=VREF}
N -80 -270 -80 -230 {lab=VREF}
N -100 -230 -80 -230 {lab=VREF}
N -240 -540 -240 -450 {lab=AVDD}
N -400 -540 -240 -540 {lab=AVDD}
N -400 -230 -400 -210 {lab=vgsu1}
N -400 -60 -400 -30 {lab=AVSS}
N -440 -30 -400 -30 {lab=AVSS}
N -360 -90 -340 -90 {lab=AVSS}
N -340 -90 -340 -30 {lab=AVSS}
N -400 -30 -340 -30 {lab=AVSS}
N -340 -270 -340 -180 {lab=VREF}
N -360 -180 -340 -180 {lab=VREF}
N -440 -180 -400 -180 {lab=AVSS}
N -460 -30 -440 -30 {lab=AVSS}
N -400 -230 -310 -230 {lab=vgsu1}
N -400 -240 -400 -230 {lab=vgsu1}
N -310 -420 -310 -230 {lab=vgsu1}
N -440 -140 -440 -30 {lab=AVSS}
N -400 -140 -400 -120 {lab=AVSS}
...
C {opin.sym} -100 -230 0 1 {name=p10 lab=VREF}
C {opin.sym} 510 -390 3 1 {name=p11 lab=IOUT1}
C {lab_wire.sym} 40 -330 0 0 {name=p3 sig_type=std_logic lab=AVSS}
C {lab_wire.sym} 390 -330 0 1 {name=p4 sig_type=std_logic lab=AVSS}
...
C {sg13cmos5l_pr/sg13_hv_pmos.sym} -380 -410 0 1 {name=MPSU2
l=6u
w=0.35u
ng=1
m=1
}
C {sg13cmos5l_pr/sg13_hv_pmos.sym} -380 -340 0 1 {name=MPSU3
l=6u
w=0.35u
ng=1
m=1
}
C {sg13cmos5l_pr/sg13_hv_pmos.sym} -380 -270 0 1 {name=MPSU4
l=6u
w=0.35u
ng=1
m=1
...
C {sg13cmos5l_pr/pnpMPA.sym} -380 -90 0 1 {name=Q3
m=1
a=1.4p
p=5.4u}
