...
N -400 -70 -400 -30 {lab=AVSS}
N -420 -30 -400 -30 {lab=AVSS}
N -420 -100 -400 -100 {lab=AVSS}
N -420 -100 -420 -30 {lab=AVSS}
N -460 -30 -420 -30 {lab=AVSS}
N -330 -330 -80 -330 {lab=VREF}
N -360 -100 -330 -100 {lab=VREF}
N -330 -330 -330 -100 {lab=VREF}
N -340 -330 -330 -330 {lab=VREF}
N -340 -410 -340 -330 {lab=VREF}
N -480 -330 -340 -330 {lab=VREF}
...
N -400 -370 -400 -130 {lab=vgsu1}
N -310 -420 -280 -420 {lab=vgsu1}
N -310 -420 -310 -370 {lab=vgsu1}
N -400 -370 -310 -370 {lab=vgsu1}
N -400 -380 -400 -370 {lab=vgsu1}
...
C {opin.sym} -480 -330 0 1 {name=p10 lab=VREF}
...
C {sg13cmos5l_pr/sg13_hv_nmos.sym} -380 -100 0 1 {name=MNSU2
l=0.5u
w=2u
ng=1
m=1
...
C {lab_wire.sym} -300 -420 0 1 {name=p15 sig_type=std_logic lab=vgsu1}
